...
const engagementModels = [
  ...
  },
  {
    ...
    description: "A fixed-scope engagement for a PoC, a specific module, or resolving a critical compatibility issue — led by our technical director.",
    whenToUse: "A low-risk way to validate a technical approach or solve an urgent, isolated problem.",
    timeline: "1-4 months",
    included: [
      "Technical director supervision",
