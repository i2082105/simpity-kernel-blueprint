...
const navigation = [
  ...
  { name: "Attack Hub", href: "/ai-agent-attack-hub" },
  {
    ...
    children: [
      ...
      { name: "Process Injection & API Interception", href: "/capabilities/process-injection" },
      { name: "Authentication Flow Control", href: "/capabilities/authentication" },
      { name: "Credential Providers Engineering", href: "/capabilities/credential-providers" },
      { name: "AD CS Security", href: "/capabilities/adcs" },
      ...
      { name: "Exchange Security Instrumentation", href: "/capabilities/exchange" },
    ],
  },
                    ...
                    >
                      ...
                      <ChevronDown
                        className={cn(
                          ...
                          mobileExpandedSection === item.name && "rotate-180"
                        )}
                      />
                    </button>
                  ) : (
